...
class RegisterDistributer extends StatefulWidget {
  const RegisterDistributer({super.key});

  @override
  State<RegisterDistributer> createState() => _RegisterDistributerState();
}

class _RegisterDistributerState extends State<RegisterDistributer> {
